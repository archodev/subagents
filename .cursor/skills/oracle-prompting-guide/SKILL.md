---
name: oracle-prompting-guide
description: A prompting guide for the oracle to improve results
alwaysApply: true
---

# Oracle Prompting Guide
Note: The Oracle is currently powered by GPT-5.2 High so this file currently contains the official prompting guide for GPT-5.2
...
Example updated spec:<user_updates_spec>
...
Example tool usage section:<tool_usage_rules>
...
Treat 4o/4.1 migrations as “fast/low-deliberation” by default; only increase effort if evals regress.
...
Same mapping as GPT-4o to preserve snappy behavior.

GPT-5

GPT-5.2

same value except minimal → none

Preserve none/low/medium/high to keep latency/quality profile consistent.
...
Preserve existing effort selection; adjust only after running evals.
...
Example prompt for a web research agentYou are a helpful, warm web research agent. Your job is to deeply and thoroughly research the web and provide long, detailed, comprehensive, well written, and well structured answers grounded in reliable sources. Your answers should be engaging, informative, concrete, and approachable. You MUST adhere perfectly to the guidelines below.
